...
def is_valid(isbn):
    ...
    - [] TODO continue with the instruction, then write the code
    ...
    if not len(isbn) == 10:
        # TODO uncomment and unpass after you do the above one
    ...
    for number, j in zip(isbn_main_numbers, range(10,1,-1)):
